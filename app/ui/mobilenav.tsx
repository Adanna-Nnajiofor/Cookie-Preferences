...
export default function MobileNav({ open, onClose }: ModalProps) {
  return (
    ...
    >
      ...
      >
        <button
          className="text-2xl place-self-end w-full flex justify-end"
          onClick={onClose}
        >
        ...
        <div className="space-y-8 px-5">
          ...
          <div className="space-y-8 pb-10">
            <button className="w-full p-3 rounded-lg border border-[#F97316] text-[#F97316]">
              Login
            </button>
            <button className="w-full p-3 rounded-lg bg-[#F97316] text-white">
              Get started
            </button>
          </div>
        </div>
